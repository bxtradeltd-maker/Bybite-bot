...
# Historical candle data is public and doesn't need auth or testnet.
# Bybit's testnet endpoint has aggressive rate limits / geo-blocking that
# make it unreliable for repeated backtest pulls, so always fetch candles
# from mainnet regardless of BYBIT_TESTNET. Live order execution above is
# untouched and still respects config.BYBIT_TESTNET.
market_data_session = HTTP(testnet=False)
