...
def _walk_to_outcome(candles, start_idx, signal):
    ...
    proven +13.2pt edge in earlier tests. TP1/TP3 and trailing/breakeven
    are available for live execution (see manage_open_position) but
    aren't modeled here yet - this keeps the backtest numbers comparable
    to what's already been validated rather than silently changing the
    R:R being tested.
    """
